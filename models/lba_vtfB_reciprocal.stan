...
parameters {
    ...
    vector[Nvars] COEFS_anodal_v_diff;
    real<lower=0> dvd_anodal_sd;
    vector[Nvars] COEFS_cathodal_v_diff;
    real<lower=0> dvd_cathodal_sd;
    vector[Nvars] COEFS_sham_v_diff;
    real<lower=0> dvd_sham_sd;
    ...
    vector[Nsubj] dvd_anodal_raw;   //change in anodal
    vector[Nsubj] dvd_cathodal_raw; //change in cathodal condition
    vector[Nsubj] dvd_sham_raw;     //change in sham condition
...
transformed parameters {
     ...
     vector[Nsubj] dvd_anodal_mean;
     vector[Nsubj] dvd_cathodal_mean;
     vector[Nsubj] dvd_sham_mean;
    ...
    // vector[Nsubj] dvf_sham_mean;
     ...
     vector[Nsubj] dvd_anodal;
     vector[Nsubj] dvd_cathodal;
     vector[Nsubj] dvd_sham;
     ...
     dvd_anodal_mean = COVS * COEFS_anodal_v_diff;
     dvd_cathodal_mean = COVS * COEFS_cathodal_v_diff;
     dvd_sham_mean = COVS * COEFS_sham_v_diff;
     ...
     dvd_anodal = dvd_anodal_raw*dvd_anodal_sd + dvd_anodal_mean;
     dvd_cathodal = dvd_cathodal_raw*dvd_cathodal_sd + dvd_cathodal_mean;
     dvd_sham = dvd_sham_raw*dvd_sham_sd + dvd_sham_mean;
     ...
     v_true = v_true_pre[subject] +
        dvd_anodal[subject]/2 .* dpost_anodal +
        dvd_cathodal[subject]/2 .* dpost_cathodal +
        dvd_sham[subject]/2 .* dpost_sham;

    //calculate v_false
     v_false = v_false_pre[subject] +
        -1*dvd_anodal[subject]/2 .* dpost_anodal +
        -1*dvd_cathodal[subject]/2 .* dpost_cathodal +
        -1*dvd_sham[subject]/2 .* dpost_sham;
...
model {
     ...
     COEFS_anodal_v_diff ~ normal(0,2);
     COEFS_cathodal_v_diff ~ normal(0,2);
     COEFS_sham_v_diff ~ normal(0,2);
     ...
     dvd_anodal_sd ~ normal(0,1);
     dvd_cathodal_sd ~ normal(0,1);
     dvd_sham_sd ~ normal(0,1);
     ...
     dvd_anodal_raw ~ normal(0,1);  //  implies  normal(dvt_anodal_mean,dvt_anodal_sd);
     dvd_cathodal_raw ~ normal(0,1);  //  implies normal(dvt_cathodal_mean,dvt_cathodal_sd);
     dvd_sham_raw ~ normal(0,1);  //  implies normal(dvt_sham_mean,dvt_sham_sd);
